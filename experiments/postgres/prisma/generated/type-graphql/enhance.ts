...
const argsInfo = {
  ...
  DeleteManyMainUserArgs: ["where", "limit"],
  ...
  UpdateManyMainUserArgs: ["data", "where", "limit"],
  ...
  DeleteManyCategoryArgs: ["where", "limit"],
  ...
  UpdateManyCategoryArgs: ["data", "where", "limit"],
  ...
  DeleteManyPatientArgs: ["where", "limit"],
  ...
  UpdateManyPatientArgs: ["data", "where", "limit"],
  ...
  DeleteManyMovieArgs: ["where", "limit"],
  ...
  UpdateManyMovieArgs: ["data", "where", "limit"],
  ...
  DeleteManyDirectorArgs: ["where", "limit"],
  ...
  UpdateManyDirectorArgs: ["data", "where", "limit"],
  ...
  DeleteManyProblemArgs: ["where", "limit"],
  ...
  UpdateManyProblemArgs: ["data", "where", "limit"],
  ...
  DeleteManyCreatorArgs: ["where", "limit"],
  ...
  UpdateManyCreatorArgs: ["data", "where", "limit"],
  ...
  DeleteManyNativeTypeModelArgs: ["where", "limit"],
  ...
  UpdateManyNativeTypeModelArgs: ["data", "where", "limit"],
  ...
  DeleteManyEquipmentArgs: ["where", "limit"],
  ...
  UpdateManyEquipmentArgs: ["data", "where", "limit"],
  ...
  DeleteManyHiddenArgs: ["where", "limit"],
...
const outputsInfo = {
  ...
  UpdateManypostAndReturnOutputType: ["uuid", "createdAt", "updatedAt", "published", "title", "subtitle", "content", "authorId", "editorId", "kind", "metadata", "author", "editor"],
  CreateManyAndReturnCategory: ["name", "slug", "number"],
  UpdateManyCategoryAndReturnOutputType: ["name", "slug", "number"],
  CreateManyAndReturnPatient: ["firstName", "lastName", "email"],
  UpdateManyPatientAndReturnOutputType: ["firstName", "lastName", "email"],
  CreateManyAndReturnMovie: ["directorFirstName", "directorLastName", "title", "director"],
  UpdateManyMovieAndReturnOutputType: ["directorFirstName", "directorLastName", "title", "director"],
  CreateManyAndReturnDirector: ["firstName", "lastName"],
  UpdateManyDirectorAndReturnOutputType: ["firstName", "lastName"],
  CreateManyAndReturnProblem: ["id", "problemText", "creatorId", "creator"],
  UpdateManyProblemAndReturnOutputType: ["id", "problemText", "creatorId", "creator"],
  CreateManyAndReturnCreator: ["id", "name"],
  UpdateManyCreatorAndReturnOutputType: ["id", "name"],
  CreateManyAndReturnNativeTypeModel: ["id", "bigInt", "byteA", "decimal"],
  UpdateManyNativeTypeModelAndReturnOutputType: ["id", "bigInt", "byteA", "decimal"],
...
const inputsInfo = {
  ...
  MainUserOrderByWithRelationInput: ["id", "email", "firstName", "age", "accountBalance", "amount", "role", "grades", "aliases", "clientPosts", "editorPosts"],
  ...
  PostOrderByWithRelationInput: ["uuid", "createdAt", "updatedAt", "isPublished", "title", "subtitle", "content", "authorId", "editorId", "kind", "metadata", "author", "editor"],
  ...
  MovieOrderByWithRelationInput: ["directorFirstName", "directorLastName", "title", "director"],
  ...
  ProblemOrderByWithRelationInput: ["id", "problemText", "creatorId", "likedBy", "creator"],
  ...
  EquipmentOrderByWithRelationInput: ["id", "name"],
  ...
  HiddenOrderByWithRelationInput: ["id", "name"],
  ...
  DirectorScalarRelationFilter: ["is", "isNot"],
  ...
  CreatorNullableScalarRelationFilter: ["is", "isNot"],
